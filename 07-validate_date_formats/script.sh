...
exceedsDaysInMonth()
{
  # Given a month name and date, this function will return 0 if
  # the specified day value is less than or equal to the max days
  # in the month; otherwise 1
...
isLeapYear()
{
  # Returns 0 if the specified year is a leap year; otherwise 1
  ...
  #      3. Years divisible by 4 and 100, but not divisible by 
...
if [ $? -eq 1 ] ; then
  exit 1        # Error reported by normdate
fi
...
# Check whether the day value is valid
